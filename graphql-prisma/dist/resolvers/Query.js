...
var Query = {
  users: function users(parent, args, _ref, info) {
    ...
    var fragment = 'fragment userId on User { id }';
    var opArgs = {
      first: args.first,
      skip: args.skip,
      after: args.after,
    ...
    return prisma.query.users(opArgs, (0, _graphqlBinding.addFragmentToInfo)(info, fragment));
  },
  ...
  posts: function posts(parent, args, _ref3, info) {
    ...
    var fragment = 'fragment userId on Post { author{id} }';
    var opArgs = {
      first: args.first,
      skip: args.skip,
      after: args.after,
    ...
    return prisma.query.posts(opArgs, (0, _graphqlBinding.addFragmentToInfo)(info, fragment));
  },
  ...
  post: function () {
    ...
    /*#__PURE__*/
    regeneratorRuntime.mark(function _callee(parent, args, _ref6, info) {
